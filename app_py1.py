...
if uploaded_file is not None:
    try:
        ...
        fig = px.scatter(rfm, x='Frequency', y='Monetary', size='Recency',
                         hover_data=['Customer ID'], title="Frequency vs Monetary (Sample Visualization)")
        ...
        if customer_id:
            try:
                ...
                if not cust_data.empty:
                    ...
                    freq_table = (cust_data.groupby('Description')['Quantity']
                                  .sum()
                                  .reset_index()
